...
function CustomQuestionContent() {
  ...
  }, [search, difficulty, page, isCoding]);
    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 44px 60px' }}>
      <Breadcrumb
        items={[
          ...
          { label: `${sectionName}: Question Library`, href: '#' },
        ]}
      />
...
export default function CustomQuestionPage() {
  return (
    <Suspense fallback={<div style={{ padding: '40px', textAlign: 'center' }}>Loading question library...</div>}>
